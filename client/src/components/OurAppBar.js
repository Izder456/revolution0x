...
import revolution0xLogo from "../images/revolution0x.png";
        ...
        <AppBar position="fixed" className="our-gradient">
          <Toolbar>
            ...
            <Link to="/" className={"logo-container" + " " + classes.grow}>
              <img src={revolution0xLogo} alt="revolution0x Logo"/>
            </Link>
            {activeAccount && (
              <div>
                ...
                >
                  <MenuItem onClick={this.handleClose}>
                    <Link className={"no-decorate"} to={"/profile/" + activeAccount}>Profile</Link>
                  </MenuItem>
                </Menu>
              </div>
            )}
